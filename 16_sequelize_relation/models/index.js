...
// (3-1) 1:1관계 설정, Player:Profile = 1:1
// Player의 pk가 Profile의 fk가 된다.
// 즉 Profile은 Player에 속해 있다.(=belongs to)
...
// (3-3) 다:다 관계 설정, Game:Team = N:N
// 하나의 팀은 여러 경기를 할 수 있고, 
// 하나의 경기에는 여러 팀(두팀)이 참여
